...
public class TestPuzzles {
    ...
    public static final NonogramGame BUFFALO_SOLUTION = new NonogramGame(null, new CellState[][]{
    ...
    public static final NonogramGame EASY_SOLUTION = new NonogramGame(null, new CellState[][]{
            {ON, ON, OFF, OFF, ON},
            {ON, ON, OFF, ON, ON},
            {ON, ON, OFF, OFF, OFF},
            {OFF, OFF, OFF, OFF, ON},
